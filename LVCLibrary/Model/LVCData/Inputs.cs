...
namespace LVC.Model.LVCData
{
    ...
    public partial class Inputs
    {
        ...
        public double LocKvVCap2 { get; set; }
        public double MwVTx4 { get; set; }
        public double MvrVTx4 { get; set; }
        public double MwVTx5 { get; set; }
        public double MvrVTx5 { get; set; }
        public double G1Mw { get; set; }
        public double G1Mvr { get; set; }
        public double G2Mw { get; set; }
        public double G2Mvr { get; set; }
    }
}