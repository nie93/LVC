...
namespace LVC.Model
{
    ...
    public class Mapper : MapperBase
    {
        ...
        public override void Map(IDictionary<MeasurementKey, IMeasurement> measurements)
        {
            ...
            Reset();
            LVC.Model.LVCData.Inputs inputData = CreateLVCDataInputs(inputMapping);
            Reset();
            LVC.Model.LVCData._InputsMeta inputMeta = CreateLVCData_InputsMeta(inputMapping);
        ...
        private LVC.Model.LVCData.Inputs CreateLVCDataInputs(TypeMapping typeMapping)
        {
        ...
        private LVC.Model.LVCData._InputsMeta CreateLVCData_InputsMeta(TypeMapping typeMapping)
        {
            Dictionary<string, FieldMapping> fieldLookup = typeMapping.FieldMappings.ToDictionary(mapping => mapping.Field.Identifier);
